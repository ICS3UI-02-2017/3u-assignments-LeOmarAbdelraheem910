...
public class Quiz1_CommandingRobots {
    ...
    public static void main(String[] args) {
        ...
        speedyboi.pickThing();
        speedyboi.move();
        //climb down the staircase on the right side
        while (speedyboi.getAvenue() <= 7) {
            //maneuver down the staircase while replacing the lights on the right side
            if (speedyboi.frontIsClear()) {
                speedyboi.putThing();
                speedyboi.move();
                speedyboi.turnRight();
        ...
        //reposition speedyboi and get it to the 9th avenue
        speedyboi.putThing();
        speedyboi.turnLeft();
        speedyboi.move();
    }
